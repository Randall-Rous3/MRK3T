...
export default function LandingPage() {
    ...
    return (
        <div className='welcome'>
            ...
            <h2 className='intro'>MRK3T is an online farm to business platform.<br /> A farmer's market to restaurant concept.<br /> A place for conscientious restaurateurs to view their local options in leu of going with the big box option. <br /> Things made by people for people.  </h2>
